...
<body>
    ...
    <section id="ekip">
        <div class="container">
            <h3 id="ekiph3">Laptop</h3>
            <div class="sutun-sol-sag">
                <img src="img/download.jpg" alt="" class="img-fluid oval">
                <h4 class="ekipisim">ASUS X515fa-ej053t</h4>
                <p class="ekipp">İşlemci Tipi: Intel Core i5 SSD Kapasitesi: 256 GB İşletim Sistemi: Windows Ekran Kartı: İntel HD Graphic 4400<br> 11.499 TL!!!!</p><button id="sep"><a href="sepet.php">Satın Al</button></a>
    ...
    <section id="iletisim">
        <div class="container">
            ...
            <footer>
                ...
                <a href="dizüstüpc.php"></i>En Yukarı</a>
            </footer>
        </div>
    </section>
